...
- Task: [[_kano/backlog/items/task/0000/KABSD-TSK-0049_document-file-first-db-index-architecture-and-trade-offs|KABSD-TSK-0049 Document file-first + DB index architecture and trade-offs]]
- Task: [[_kano/backlog/items/task/0000/KABSD-TSK-0050_document-index-config-artifact-paths-and-rebuild-workflow|KABSD-TSK-0050 Document index config, artifact paths, and rebuild workflow]]
- Task: [[_kano/backlog/items/task/0000/KABSD-TSK-0051_extend-validate-userstories-to-cover-db-index-and-embeddings-stories|KABSD-TSK-0051 Extend validate_userstories to cover DB index and embeddings stories]]
