...
state: Done
tags: []
title: Clean up legacy platform roots (_index, _logs, sandboxes) and align scripts
  to shared layout
type: Task
...
2026-01-12 07:25 [agent=codex-cli] Start: audit platform-level roots (_index, _logs/agent_tools, sandboxes) and align scripts to shared/product layout per cross-product rules.
2026-01-12 07:32 [agent=codex-cli] Aligned shared/platform paths: audit logs default to _kano/backlog/_shared/logs/agent_tools (with legacy fallback) and copied existing log there; ConfigLoader sandbox_root now resolves to _kano/backlog_sandbox/<name>; marked legacy _index/_logs/sandboxes folders with README to prevent new writes; updated tests and logging docs accordingly.
