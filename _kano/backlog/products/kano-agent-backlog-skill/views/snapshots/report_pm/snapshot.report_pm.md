...
- **NotImplementedError** in `tests/test_snapshot.py`: "oops')", encoding="utf-8" 

- **TODO** in `src/kano_backlog_ops/adr.py`: "Implement" 

- **NotImplementedError** in `src/kano_backlog_ops/adr.py`: "list_adrs not yet implemented" 

- **TODO** in `src/kano_backlog_ops/snapshot.py`: "Integrate with doctor commands" 

- **NotImplementedError** in `src/kano_backlog_cli/commands/config_cmd.py`: "config export now requires explicit --out path" 

- **TODO** in `src/kano_backlog_cli/commands/snapshot.py`: "recursive print" 
