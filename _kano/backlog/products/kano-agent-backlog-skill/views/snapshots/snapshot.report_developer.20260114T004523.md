...
**Generated:** 2026-01-14T01:23:16.645846
...
| Reproducible docs metadata (VCS-agnostic; remove timestamps) | missing | <br>- `Worklog: 2026-01-14 00:11 [agent=developer] Created item` |
...
| NotImplementedError | `skills/kano-agent-backlog-skill/tests/test_snapshot.py:129` | oops')", encoding="utf-8 |  |
