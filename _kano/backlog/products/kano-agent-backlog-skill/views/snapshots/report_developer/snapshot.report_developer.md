...
| Reproducible docs metadata (VCS-agnostic; remove timestamps) | done | <br>- `Worklog: 2026-01-14 22:48 [agent=github-copilot] [model=unknown] VCS metadata schema redesigned and implemented: branch/revno/hash model, no tags/label, multi-provider support, backward compatible` |
