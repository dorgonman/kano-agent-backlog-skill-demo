...
- Items in `_kano/backlog/products/<product>/items/**`
- Decisions in `_kano/backlog/products/<product>/decisions/**`
- Tree navigation via Epic `.index.md` MOC files + wikilinks (Bases is not a tree renderer)

## Files in this demo

- `_kano/backlog/products/<product>/views/Dashboard_ObsidianBase.base`: a multi-view Base config that mirrors the Dataview dashboard sections.
- `_kano/backlog/products/<product>/views/Dashboard_ObsidianBase_Readme.md`: usage notes + view mappings.
...
1) Open `_kano/backlog/products/<product>/views/Dashboard_ObsidianBase.base` in Obsidian.
2) Confirm the source folder is `_kano/backlog/products/<product>/items` (Obsidian may prompt you on first open).
...
- Source folder: `_kano/backlog/products/<product>/items`
