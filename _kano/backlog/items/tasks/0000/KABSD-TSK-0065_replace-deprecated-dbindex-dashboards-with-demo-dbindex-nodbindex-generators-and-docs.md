...
2026-01-06 07:48 [agent=codex-cli] State -> Done. Added generate_demo_views.py to generate DBIndex/NoDBIndex demo dashboards under views/_demo; updated Dashboard docs and views reference; added project-specific focus-view tool example; retained legacy Dashboard_DBIndex_* files as deprecated pointers due to delete restrictions in this environment.
