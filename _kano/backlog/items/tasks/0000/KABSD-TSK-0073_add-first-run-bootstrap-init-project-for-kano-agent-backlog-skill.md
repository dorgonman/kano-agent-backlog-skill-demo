...
2026-01-06 12:07 [agent=codex-cli] Implemented self-contained bootstrap: init_backlog now writes baseline config/views; added init_project.py with optional guide templates; config supports project.name/prefix; create_item defaults to config; docs updated.
