...
def main() -> int:
    ...
    #   `skills/kano-agent-backlog-skill/scripts/backlog/view_generate_demo.py`
    ...
    generator = REPO_ROOT / "skills" / "kano-agent-backlog-skill" / "scripts" / "backlog" / "view_generate_demo.py"
    cmd = [
        python,
        str(generator),
        "--backlog-root",
